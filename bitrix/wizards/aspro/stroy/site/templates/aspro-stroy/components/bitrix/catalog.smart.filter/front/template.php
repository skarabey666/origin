							...
							<div class="bx_filter_parameters_box_title" >
								<span>
									<?if(strlen($arItem['FILTER_HINT'])):?>
										<span data-html="true" data-toggle="tooltip" data-delay='{"show":"1000", "hide":"1000"}' data-original-title="<?=str_replace('"', "'", $arItem['FILTER_HINT'])?>" rel="tooltip"><?=$arItem["NAME"]?></span>
									<?else:?>
										<?=$arItem["NAME"]?>
									<?endif;?>
								</span>
									...
									<div class="wrapp_all_inputs wrap_md">
										...
										<div class="wrapp_slider iblock">
											<div class="bx_ui_slider_track" id="drag_track_<?=$key?>">
												...
												<div class="bx_ui_slider_pricebar_V"  style="left: 0;right: 0;" id="colorAvailableActive_<?=$key?>"></div>
												<div class="bx_ui_slider_range" 	id="drag_tracker_<?=$key?>"  style="left: 0;right: 0;">
													<span class="bx_ui_slider_handle left"  style="left:0;" href="javascript:void(0)" id="left_slider_<?=$key?>"></span>
													<span class="bx_ui_slider_handle right" style="right:0;" href="javascript:void(0)" id="right_slider_<?=$key?>"></span>
												</div>
											</div>
											<?
											$arJsParams = array(
