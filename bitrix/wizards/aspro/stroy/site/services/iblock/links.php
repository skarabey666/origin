...
if(!CModule::IncludeModule("aspro.stroy")) return;
...
// iblocks ids
$servicesIBlockID = CCache::$arIBlocks[WIZARD_SITE_ID]["aspro_stroy_content"]["aspro_stroy_services"][0];
$studyIBlockID = CCache::$arIBlocks[WIZARD_SITE_ID]["aspro_stroy_catalog"]["aspro_stroy_study"][0];
$staffIBlockID = CCache::$arIBlocks[WIZARD_SITE_ID]["aspro_stroy_content"]["aspro_stroy_staff"][0];
$reviewsIBlockID = CCache::$arIBlocks[WIZARD_SITE_ID]["aspro_stroy_content"]["aspro_stroy_reviews"][0];
$projectsIBlockID = CCache::$arIBlocks[WIZARD_SITE_ID]["aspro_stroy_content"]["aspro_stroy_projects"][0];
$catalogIBlockID = CCache::$arIBlocks[WIZARD_SITE_ID]["aspro_stroy_catalog"]["aspro_stroy_catalog"][0];
$stockIBlockID = CCache::$arIBlocks[WIZARD_SITE_ID]["aspro_stroy_content"]["aspro_stroy_stock"][0];
$newsIBlockID = CCache::$arIBlocks[WIZARD_SITE_ID]["aspro_stroy_content"]["aspro_stroy_news"][0];
$articlesIBlockID = CCache::$arIBlocks[WIZARD_SITE_ID]["aspro_stroy_content"]["aspro_stroy_articles"][0];
