...
$iblockTYPE = "aspro_stroy_content";
...
if(WIZARD_INSTALL_DEMO_DATA){
	...
	CUserOptions::SetOption("form", "form_element_".$iblockID, array(
		"tabs" => 'edit1--#--'.GetMessage("WZD_OPTION_120").'--,--ACTIVE--#--'.GetMessage("WZD_OPTION_2").'--,--ACTIVE_FROM--#--'.GetMessage("WZD_OPTION_4").'--,--ACTIVE_TO--#--'.GetMessage("WZD_OPTION_6").'--,--NAME--#--'.GetMessage("WZD_OPTION_8").'--,--CODE--#--'.GetMessage("WZD_OPTION_10").'--,--SORT--#--'.GetMessage("WZD_OPTION_14").'--,--IBLOCK_ELEMENT_PROP_VALUE--#--'.GetMessage("WZD_OPTION_16").'--,--PROPERTY_'.$arProperty["FORM_PROJECT"].'--#--'.GetMessage("WZD_OPTION_122").'--,--PROPERTY_'.$arProperty["FORM_QUESTION"].'--#--'.GetMessage("WZD_OPTION_20").'--,--PROPERTY_'.$arProperty["PHOTOS"].'--#--'.GetMessage("WZD_OPTION_18").'--,--PROPERTY_'.$arProperty["BIG_PHOTOS"].'--#--'.GetMessage("WZD_OPTION_194").'--,--PROPERTY_'.$arProperty["ORDERER"].'--#--'.GetMessage("WZD_OPTION_124").'--,--PROPERTY_'.$arProperty["SITE"].'--#--'.GetMessage("WZD_OPTION_116").'--,--PROPERTY_'.$arProperty["PROJECT_S"].'--#--'.GetMessage("WZD_OPTION_126").'--,--PROPERTY_'.$arProperty["PROJECT_TYPE"].'--#--'.GetMessage("WZD_OPTION_88").'--,--PROPERTY_'.$arProperty["DOCUMENTS"].'--#--'.GetMessage("WZD_OPTION_30").'--,--PROPERTY_'.$arProperty["LINK_PROJECTS"].'--#--'.GetMessage("WZD_OPTION_128").'--,--PROPERTY_'.$arProperty["LINK_REVIEWS"].'--#--'.GetMessage("WZD_OPTION_198").'--,--LINKED_PROP--#--'.GetMessage("WZD_OPTION_98").'--;--edit5--#--'.GetMessage("WZD_OPTION_32").'--,--PREVIEW_PICTURE--#--'.GetMessage("WZD_OPTION_34").'--,--PREVIEW_TEXT--#--'.GetMessage("WZD_OPTION_36").'--;--edit6--#--'.GetMessage("WZD_OPTION_38").'--,--DETAIL_PICTURE--#--'.GetMessage("WZD_OPTION_40").'--,--DETAIL_TEXT--#--'.GetMessage("WZD_OPTION_42").'--;--edit14--#--'.GetMessage("WZD_OPTION_44").'--,--IPROPERTY_TEMPLATES_ELEMENT_META_TITLE--#--'.GetMessage("WZD_OPTION_46").'--,--IPROPERTY_TEMPLATES_ELEMENT_META_KEYWORDS--#--'.GetMessage("WZD_OPTION_48").'--,--IPROPERTY_TEMPLATES_ELEMENT_META_DESCRIPTION--#--'.GetMessage("WZD_OPTION_50").'--,--IPROPERTY_TEMPLATES_ELEMENT_PAGE_TITLE--#--'.GetMessage("WZD_OPTION_52").'--,--IPROPERTY_TEMPLATES_ELEMENTS_PREVIEW_PICTURE--#--'.GetMessage("WZD_OPTION_54").'--,--IPROPERTY_TEMPLATES_ELEMENT_PREVIEW_PICTURE_FILE_ALT--#--'.GetMessage("WZD_OPTION_56").'--,--IPROPERTY_TEMPLATES_ELEMENT_PREVIEW_PICTURE_FILE_TITLE--#--'.GetMessage("WZD_OPTION_58").'--,--IPROPERTY_TEMPLATES_ELEMENT_PREVIEW_PICTURE_FILE_NAME--#--'.GetMessage("WZD_OPTION_60").'--,--IPROPERTY_TEMPLATES_ELEMENTS_DETAIL_PICTURE--#--'.GetMessage("WZD_OPTION_62").'--,--IPROPERTY_TEMPLATES_ELEMENT_DETAIL_PICTURE_FILE_ALT--#--'.GetMessage("WZD_OPTION_56").'--,--IPROPERTY_TEMPLATES_ELEMENT_DETAIL_PICTURE_FILE_TITLE--#--'.GetMessage("WZD_OPTION_58").'--,--IPROPERTY_TEMPLATES_ELEMENT_DETAIL_PICTURE_FILE_NAME--#--'.GetMessage("WZD_OPTION_60").'--,--SEO_ADDITIONAL--#--'.GetMessage("WZD_OPTION_64").'--,--TAGS--#--'.GetMessage("WZD_OPTION_66").'--;--edit2--#--'.GetMessage("WZD_OPTION_68").'--,--SECTIONS--#--'.GetMessage("WZD_OPTION_68").'--;--;--',
	));
	// list user options
	CUserOptions::SetOption("list", "tbl_iblock_list_".md5($iblockTYPE.".".$iblockID), array(
		'columns' => 'NAME,PREVIEW_PICTURE,PROPERTY_'.$arProperty["PROJECT_S"].',ACTIVE,SORT,TIMESTAMP_X,ID', 'by' => 'timestamp_x', 'order' => 'desc', 'page_size' => '20',
	));
}
